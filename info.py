...
URL = "https://vasu-7e551967712e.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vasu-7e551967712e.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://vasu-7e551967712e.herokuapp.com/".format(FQDN)
else:
    URL = "https://vasu-7e551967712e.herokuapp.com/".format(FQDN)
